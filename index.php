        ...
        <div class="col-lg-4 col-sm-6">
            <div class="card mb-3 shadow">
                ...
                <div class="card-body">
                    ...
                    <a href="https://fr.wikipedia.org/wiki/Assinie" class="btn bouton">Voir plus</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-4 col-sm-6">
            <div class="card mb-3 shadow">
                ...
                <div class="card-body">
                    ...
                    <a href="https://fr.wikipedia.org/wiki/Jacqueville_(C%C3%B4te_d'Ivoire)" class="btn bouton">Voir plus</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-4 col-sm-6">
            <div class="card mb-3 shadow">
                ...
                <div class="card-body">
                    ...
                    <a href="https://fr.wikipedia.org/wiki/Sassandra" class="btn bouton">Voir plus</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-4 col-sm-6">
            <div class="card mb-3 shadow">
                ...
                <div class="card-body">
                    ...
                    <a href="https://fr.wikipedia.org/wiki/Grand-Bassam" class="btn bouton">Voir plus</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-4 col-sm-6">
            <div class="card mb-3 shadow">
                ...
                <div class="card-body">
                    ...
                    <a href="https://fr.wikipedia.org/wiki/San-P%C3%A9dro" class="btn bouton">Voir plus</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-4 col-sm-6">
            <div class="card mb-3 shadow">
                ...
                <div class="card-body">
                    ...
                    <a href="https://fr.wikipedia.org/wiki/Fresco_(C%C3%B4te_d%27Ivoire)" class="btn bouton">Voir plus</a>
                </div>
            </div>
        </div>
    </div>
                ...
                <form action="index.php" method="POST">
                    <div class="row">
                      ...
                      <div class="col mt-3 text-center">
                          <button class="btn bouton" name="enregistrer">Envoyer</button>
                      </div>
                </div>
                </form>
        </div>
            ...
            <div class="col">
                <!-- Copyright -->
                    <div class="text-center p-3">
                        © 2021 Copyright
                        <p style="color: rgb(6, 99, 128);">ByAlexandraMoussaVeketo</p>
                    </div>
            </div>
        </div>
    </div>
